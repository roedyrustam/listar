...
class UtilIcon {
  static Map<String, IconData> fontAwesomeIconsMap = <String, IconData>{
  ...
  static IconData getIconData(String? name) {
    ...
    if (name != null && name.isNotEmpty) {
      String convertName = name.replaceAll(RegExp('far fa-'), '');
      convertName = convertName.replaceAll(RegExp('fas fa-'), '');
      List<String> split = convertName.split('-');
      if (split.length > 1) {
        String long = split
            .skip(1)
            .take(split.length)
